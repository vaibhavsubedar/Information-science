'use strict';
const defaultRoutingPath = '/informationscience/api';
...
mongoose.connect('mongodb://127.0.0.1/informationscience');
...
swaggerTools.initializeMiddleware(swaggerDocument, function (middleware) {
  ...
  var port = process.env.PORT || defaultPort;
    app.listen(port, () => { console.info(`Inforation Science APIs running on ${port}`) });
});